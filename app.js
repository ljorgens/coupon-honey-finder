...
const submitCoupon = function (code, desc, domain) {
...
const submitCoupon_callback = function(resp, domain){
...
const parseCoupons = function(coupons) {
    try{
        ...
        couponDisplay.innerHTML = '<div class="submit-button">Submit Coupon</div><h1>Coupons</h1><p>Browse coupons below that have been used for <strong>' +domain+'</strong></p>'
